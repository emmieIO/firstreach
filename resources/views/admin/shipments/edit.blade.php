<x-admin-layout>
    <div class="col">
        <section class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal form-bordered" method="POST" action="{{ route("shipments.update", $shipment->uuid) }}">
                    @csrf
                    @method("PUT")
                    ...
                    <div class="form-group row pb-4">
                        <label class="col-lg-3 control-label text-lg-end pt-2" for="sender_address">Sender
                            Address</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row pb-4">
                        <label class="col-lg-3 control-label text-lg-end pt-2" for="receiver_phone">Receiver
                            Phone</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row pb-4">
                        <label class="col-lg-3 control-label text-lg-end pt-2" for="receiver_email">Receiver
                            Email</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row pb-4">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control" id="origin_id" name="origin_id">
                                <option value="{{ $shipment->origin_id }}">{{ $shipment->origin->name }} (current)</option>
                    ...
                    <div class="form-group row pb-4">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control" id="destination_id" name="destination_id">
                                <option value="{{ $shipment->destination_id }}">{{ $shipment->destination->name }} (current)</option>
                                @foreach($locations as $location)
                    ...
                    <div class="form-group row pb-4">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control" id="category" name="category_id">
                                <option value="{{ $shipment->category_id }}">{{ $shipment->category->name }} (current)</option>
                    ...
                    <div class="form-group row pb-4">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control" id="status" name="status">
                                <option value="{{ $shipment->status }}">{{ $shipment->status }} (current)</option>
                    ...
                    <div class="form-group row pb-4">
                        ...
                        <div class="col-lg-6">
                            <textarea class="form-control" id="description"
                                name="description">{{ old('description', $shipment->description) }}</textarea>
                            @error("description")
                                <small class="fs-sm text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row pb-4">
                        ...
                        <div class="col-lg-6">
                            <input type="datetime-local" class="form-control" id="expected_delivery_date"
                                name="expected_delivery_date" value="{{ old('expected_delivery_date', $shipment->expected_delivery_date) }}">
