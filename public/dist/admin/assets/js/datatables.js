(function () {
    ...
    document.getElementById("reactivity-delete").addEventListener("click", function () {
        if (table1.getData().length > 0) {
            // Remove last row from the table
            table1.deleteRow(table1.getData()[table1.getData().length - 1].id);
        }
    });
    ...
    document.getElementById("reset").addEventListener("click", function () {
        ...
        // Optionally, add the new row
        table1.addRow({ name: "Added a New Row", position: "New", office: "New" });

        // Reset table data from the original tabledata
