...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::H3pdUbPqFgkOwUnQ',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::CpPuqgfBKPB731nm',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::CXJjoz1k0I3tjQjx',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/admin/(?|users/([^/]++)/destroy(*:39)|c(?|ategories/([^/]++)(?|/edit(*:76)|(*:83)|(*:90))|ontact\\-messages/([^/]++)(?|(*:126)))|locations/([^/]++)(?|/edit(*:162)|(*:170)|(*:178))|shipments/(?|([^/]++)(?|/edit(*:216)|(*:224)|(*:232))|history(*:248)|([^/]++)/history(?|(*:275)|/(?|create(?|(*:296))|([^/]++)/(?|edit(?|(*:324))|destroy(*:340))))))|/verify\\-email/([^/]++)/([^/]++)(*:385)|/storage/(.*)(*:406))/?$}sDu',
    ),
    3 => 
    array (
      39 => 
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'create.shipment.history',
          ),
          1 => 
          array (
            0 => 'uuid',
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'shipment.history.update',
          ),
          1 => 
          array (
            0 => 'uuid',
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'shipment.history.delete',
          ),
          1 => 
          array (
            0 => 'uuid',
  ...
  array (
    ...
    array (
      ...
      array (
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:0:{}s:8:"function";s:845:"function () {
                    ...
                    return response(\\Illuminate\\Support\\Facades\\View::file(\'C:\\\\Users\\\\marko\\\\Documents\\\\consignment-app\\\\vendor\\\\laravel\\\\framework\\\\src\\\\Illuminate\\\\Foundation\\\\Configuration\'.\'/../resources/health-up.blade.php\', [
                        \'exception\' => $exception,
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ShipmentTrackingController@track',
        'controller' => 'App\\Http\\Controllers\\ShipmentTrackingController@track',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'get.shipment.tracking',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\AdminUsersController@dashboard',
        'controller' => 'App\\Http\\Controllers\\AdminUsersController@dashboard',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\CustomerMessageController@store',
        'controller' => 'App\\Http\\Controllers\\CustomerMessageController@store',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'admin/categories/{uuid}/edit',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ShipmentController@history',
        'controller' => 'App\\Http\\Controllers\\ShipmentController@history',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'admin/shipments/{uuid}/history',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\ShipmentHistoryController@logs',
        'controller' => 'App\\Http\\Controllers\\ShipmentHistoryController@logs',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'admin/shipments/{uuid}/history/create',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\ShipmentHistoryController@create',
        'controller' => 'App\\Http\\Controllers\\ShipmentHistoryController@create',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
        ),
        'as' => 'create.shipment.history',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ShipmentHistoryController@store',
        'controller' => 'App\\Http\\Controllers\\ShipmentHistoryController@store',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
        ),
        'as' => 'store.shipment.history',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      'uri' => 'admin/shipments/{uuid}/history/{historyId}/edit',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\ShipmentHistoryController@edit',
        'controller' => 'App\\Http\\Controllers\\ShipmentHistoryController@edit',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
        ),
        'as' => 'shipment.history.edit',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ShipmentHistoryController@update',
        'controller' => 'App\\Http\\Controllers\\ShipmentHistoryController@update',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
        ),
        'as' => 'shipment.history.update',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      'uri' => 'admin/shipments/{uuid}/history/{historyId}/destroy',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\ShipmentHistoryController@destroy',
        'controller' => 'App\\Http\\Controllers\\ShipmentHistoryController@destroy',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
        ),
        'as' => 'shipment.history.delete',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      'uri' => 'admin/contact-messages/{uuid}',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\CustomerMessageController@destroy',
        'controller' => 'App\\Http\\Controllers\\CustomerMessageController@destroy',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
